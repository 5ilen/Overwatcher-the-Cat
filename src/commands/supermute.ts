...
export async function handleSuperMuteCommand(client: Client, message: Message) {
  ...
  await safeSend(message.channel, `<@${member.id}> получает мутик на 14 часов 37 минут`);
